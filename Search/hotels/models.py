...
class Hotel(models.Model):
    ...
    latitude = models.DecimalField(verbose_name="Hotel latitude", max_digits=9, decimal_places=6)
    longitude = models.DecimalField(verbose_name="Hotel longitude", max_digits=9, decimal_places=6)
